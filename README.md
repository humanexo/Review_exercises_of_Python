...
A continuación, encontrarás una serie de ejercicios básicos de programación para que los implementes en Python.
El objetivo de esta actividad es repasar algunos conceptos y familiarizarnos con algunas convenciones del
lenguaje.
